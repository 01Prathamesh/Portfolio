...
const Project = ({ darkMode }) => {
  ...
  return (
    <div className={`project-section-wrapper ${darkMode ? 'dark' : ''}`}>
      
      {/* === Projects Section === */}
      <section className="project-section" id="projects">
        <h2 className="section-title" data-aos="fade-down">
          <span style={{ borderBottom: '2px solid #00d4ff' }}>Projects</span>
        </h2>
      ...
      <section className="video-section" id="project-videos">
        ...
        <div className="video-grid">
          {videos.map((video, index) => (
            <div className="video-card-modern" key={index} data-aos="zoom-in">
